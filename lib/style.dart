...
Color backgroundColor0 = Color(0xffFCD5C7);
Color backgroundColor1 = Color(0xffE5EBED);
Color backgroundColor2 = Color(0xffDCD1EF);

Color whiteColor = Color(0xffFBFCFD);
Color blackColor = Color(0xff252D48);
Color userShadow = Color(0xff12637D);

Color partColor0 = Color(0xffF4DBE6);
Color partColor1 = Color(0xffFFB987);
Color partColor2 = Color(0xffFF78A9);
...
TextStyle UserOptionsStyle = GoogleFonts.poppins(
  fontSize: 16,
  color: blackColor,
);
